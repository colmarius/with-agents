...
4. **The practical loop:** use small, repo-local artifacts: `AGENTS.md` as the map, skills as repeatable procedures, work items/plans as durable state, and verification as the exit criterion.
...
6. **`AGENTS.md`: the map, not the manual** (2 min)
7. **Agent Skills: procedural knowledge on demand** (2 min)
8. **Work items: durable state across thread death** (2 min)
9. **Handoffs + verification: keep humans calibrated** (2 min)
10. **A minimal durable-context loop you can copy** (2 min)
11. **Start small: doing the thing is doing the thing** (1 min)
12. **Summary / Q&A** (1 min)

If the talk needs to be tighter, merge slides 6-7 into "Maps and procedures" and slides 8-9 into "State and evidence" for a 10-slide version.
