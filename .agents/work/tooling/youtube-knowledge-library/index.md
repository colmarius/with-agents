...
- Execute only the AI-only nineteenth bounded backfill batch from
  `handoff-task-5t.md` in a dedicated implementation thread. Keep the
  two-attempt ceiling, then derive Task 5u from actual outcomes without
