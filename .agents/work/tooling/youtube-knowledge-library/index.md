...
- Derive only a dedicated Task 5s handoff from Task 5r's actual AI-only
  maximum-two evidence. Do not begin another capture batch, start synthesis,
  complete Task 5, or begin Task 6.
