...
- Execute only the AI-only twenty-sixth bounded backfill batch from
  `handoff-task-5aa.md` in a dedicated implementation thread. Keep the
  two-attempt ceiling, then derive Task 5ab from actual outcomes without
