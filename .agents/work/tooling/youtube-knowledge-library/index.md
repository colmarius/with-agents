...
- Derive a dedicated Task 5r handoff for the next AI-only maximum-two bounded
  backfill batch. Keep Coding at zero capture commands, and do not start
  synthesis, complete Task 5, or begin Task 6.
