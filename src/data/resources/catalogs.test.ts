...
test('AI groups broad resources while preserving substantive coding cross-listings', () => {
  ...
  assert.deepEqual(
    ai.resourceIds,
    [
      156, 153, 152, 151, 150, 146, 127, 123, 121, 120, 108, 119, 110, 107, 111,
      52, 49, 23, 33, 55, 73, 128, 129, 130, 131, 134, 137,
    ],
  );
  for (const [section, ids] of [
    ...
    [
      'implications-risks',
      [156, 151, 150, 123, 119, 110, 107, 111, 128, 129, 130, 131, 134, 137],
    ],
  ] as const) {
    assert.deepEqual(
  ...
  for (const id of [
    156, 151, 150, 146, 127, 123, 120, 119, 52, 49, 23, 128, 129, 130, 131, 134,
    137,
  ]) {
