...
- **Build small programmable environments around the model**: An invoice workflow may need OCR for ambiguous input, but code can perform calculations cheaply, repeatably, and verifiably. Ronacher uses this example to argue that many non-coding tasks can be decomposed into executable steps ([20:38–23:00](https://www.youtube.com/watch?v=u_k9cwDNPcM&t=1238s)).
