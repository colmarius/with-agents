...
- **Test-driven development includes design decisions**: TDD starts with a test for desired behavior. Beck emphasizes the choices around that cycle: before writing the test, he chooses the interface; once it passes, he considers future cases and whether the code needs restructuring ([42:27–45:26](https://www.youtube.com/watch?v=aSXaxOdVtAQ&t=2547s)).
