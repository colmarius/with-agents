...
- **Mutual amplification requires deliberate records**: Because reading every sub-agent trajectory no longer scales, he reads the final decision summary end to end and asks agents to record learnings, friction, and unusual choices, while warning that generated explanations can be unreliable after context loss ([01:02:29]-[01:04:58]).
...
- **Writing with agents still needs an editorial owner**: Osmani uses research agents to map outside views, compares handwritten and model drafts, and sometimes applies readability passes, but worries about homogenized AI prose and says he reviews every line before publishing ([01:17:41]-[01:26:15]).
