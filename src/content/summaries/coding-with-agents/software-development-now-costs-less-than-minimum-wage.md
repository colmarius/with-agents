...
- **The headline describes inference cost, not total software-engineering cost**: Huntley distinguishes coding from software engineering, then says looping Sonnet 4.5 produced a prior estimate of $10.42 per hour. The talk supplies neither the calculation nor evidence about correctness, review, deployment, operations, or maintenance, so the figure cannot establish the cost of delivering reliable software ([00:52–05:11](https://www.youtube.com/watch?v=7Pkwv353DeI&t=52s)).
