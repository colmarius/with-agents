...
Salvatore Sanfilippo's Italian-language playlist works best as a research and engineering notebook rather than a course with one settled thesis. It moves between model representations, reasoning, interpretability, architecture papers, open weights, local inference, and the economics of useful computation.
...
- **Representations preserve selected information, not the whole object.** Sanfilippo introduces embeddings as lossy numeric representations and follows the trade-offs through similarity search, quantization, and dimensionality reduction ([00:00:57–00:10:48](https://www.youtube.com/watch?v=T5b69_8f5MI&t=57s)).
