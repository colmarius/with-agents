...
Formal methods make a system's expected behavior precise enough to check with mathematics and automated tools. Hillel Wayne explains how they expose design errors, when property-based testing is a more practical option, and why generating a specification with AI does not mean it checks anything useful.
...
- **A passing check may say nothing useful**: Based on his experiments as of March 2026, Wayne says models can produce formal syntax yet fail to invent meaningful properties. His example is “P is true or P is not true”: it always holds, regardless of whether the system works. He also reports difficulty with liveness properties, which concern how a system progresses over time. People still need to state what the design should accomplish [1:05:24–1:08:08](https://www.youtube.com/watch?v=KSkcgIYQy0U&t=3924s).
