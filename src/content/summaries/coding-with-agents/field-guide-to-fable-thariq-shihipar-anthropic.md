...
- **The prompt is a map, not the territory**: The real codebase and its constraints contain decision points the prompt did not specify. As agents traverse more of that territory, finding known unknowns, unknown knowns, and unknown unknowns becomes a human bottleneck [09:19–10:09](https://www.youtube.com/watch?v=9fubhllmsBU&t=559s).
