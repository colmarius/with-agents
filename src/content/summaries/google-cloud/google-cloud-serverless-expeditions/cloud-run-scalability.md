...
- **Scale-up can add latency:** When the harness moves from 10 to 2,000 request loops, requests queue while Cloud Run adds instances [03:14–04:16](https://www.youtube.com/watch?v=8YtsV8BNTqY&t=194s).
- **The headline result is tightly bounded:** At 30,000 loops the display still reports 100% success, but the presenters warn that a real database must sustain the traffic independently and that more active instances cost money [04:16–06:26](https://www.youtube.com/watch?v=8YtsV8BNTqY&t=256s).
