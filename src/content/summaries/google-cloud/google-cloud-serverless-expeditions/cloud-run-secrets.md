...
- **Access mode affects freshness:** In the 2021 behavior described, mounted-file and client-library access can obtain the current value, while an environment variable requires a Cloud Run redeployment after a secret update [04:11–05:14](https://www.youtube.com/watch?v=JIE89dneaGo&t=251s).
