...
- **Negative evidence is useful but incomplete**: No node memory alert alongside a workload alert supports a service-local hypothesis; it does not prove infrastructure was uninvolved ([01:03–02:08](https://www.youtube.com/watch?v=lHCB_i_rWAI&t=63s)).
- **Compare node and container scope**: Elevated node and container CPU can reveal which colocated workloads were affected ([02:08–03:11](https://www.youtube.com/watch?v=lHCB_i_rWAI&t=128s)).
