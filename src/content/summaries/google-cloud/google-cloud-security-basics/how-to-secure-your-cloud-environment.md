...
This series opener uses Google Cloud's shared-responsibility model to separate provider-operated platform security from the controls customers must apply to their applications and cloud resources.
