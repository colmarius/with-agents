...
For browser clients, read the newer [RFC 10017 browser-based applications BCP](https://www.rfc-editor.org/rfc/rfc10017.html) alongside RFC 9700. It compares backend-for-frontend, token-mediating backend, and browser-only architectures under the threat of malicious JavaScript. No choice eliminates application risks such as XSS, compromised dependencies, stolen key material, or incorrect authorization at the resource server.
