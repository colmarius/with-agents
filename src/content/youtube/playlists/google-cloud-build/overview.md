...
- Manifest: 5 entries, all marked available in the committed manifest.
- Transcripts: 5 captured.
- Summaries: 5 reviewed.
- Incorporated: 5.
...
- Priyanka Vergadia, whose affiliation is not provided by the captured source, separates restaurant-edge decisions from centralized fleet policy, event processing, model training, and forecast distribution in the fictitious Abe's Burger demo ([summary](../../videos/c2I4G7UH408/summary.md)).
