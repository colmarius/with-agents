...
- Sanfilippo's practical objection starts with scale: he recalls figures around 673 billion parameters for DeepSeek and one trillion for Kimi K2.5, while acknowledging that he does not remember every model size. These figures are speaker-reported context, not independently checked specifications. [00:06:11]
...
- Keep model openness and desktop economics separate. Weights can support auditing, adaptation, alternative hosting, and regional resilience even when personal inference is uneconomic.
