...
- Banking-as-a-service replaces one-to-one links between a core system and each front end with reusable microservices behind an API layer, so partners can consume bounded financial capabilities. [00:01:04]-[00:03:11]
...
- The 2022 service mapping puts API management at the integration boundary and routes batch and event data through storage, messaging, transformation, warehousing, cataloging, analytics, and machine-learning services. [00:06:23]-[00:08:30]
- Core services are shown as event-driven microservices on GKE using Spanner and Pub/Sub, with identity, data locality, encryption, tokenization, logging, incident monitoring, and SLAs treated as system-wide concerns. [00:08:30]-[00:10:38]
