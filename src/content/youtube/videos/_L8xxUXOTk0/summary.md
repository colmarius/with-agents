...
publishedAt: "2026-04-02T19:00:41Z"
sourceLanguage: en
summaryLanguage: en
...
Slack repeatedly frames several conclusions as directional or provocative. The recording offers founder experience and examples, not audited financial data, controlled product comparisons, or evidence that its forecasts apply uniformly across developers, enterprises, and software categories.
...
- Slack rejects moat-first product planning in the current AI market. He says Amp instead tries to build for frontier users, move ahead quickly, and remove old features when they impede new work ([00:45:57]-[00:53:09]).

## Practical Implications

- Match review effort to the consequences of failure and the stability of the foundations beneath generated code.
- Treat remote agent execution as infrastructure work, including isolation, feedback loops, and concise evidence that a human can review.
- Build for a clearly chosen user and revisit product assumptions frequently rather than treating current agent features or pricing as durable advantages.

## Questions and Tensions

- Slack's account of customer behavior and Amp usage is not independently verified in the recording, and he qualifies parts of the model-lab economics as inference rather than inside knowledge.
- Frontier focus can accelerate experimentation while excluding price-sensitive users and organizations with security or procurement requirements.
- The software-business forecast uses illustrative percentages and examples, not measured replacement rates, maintenance costs, or long-term outcomes for generated alternatives.

## Source

- [YouTube video](https://www.youtube.com/watch?v=_L8xxUXOTk0)
