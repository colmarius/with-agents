...
- Because ordered delivery is regional, publishers using ordering keys should target a regional endpoint so related messages are published into the same region. [00:01:03]-[00:02:06]
...
- Tune retry and timeout policies together with idempotency, backpressure, and monitoring so recovery does not amplify overload or duplicate side effects.
