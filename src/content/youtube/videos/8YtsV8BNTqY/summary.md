...
- The service sends Pub/Sub signals when an instance becomes ready and when it is about to shut down; the dashboard does not show a new instance until startup completes. [00:02:08]-[00:03:14]
...
- The experiment then raises the load-generating loops to 30,000 and the display still reports a 100% success rate; the presenters warn that a real database must independently sustain the traffic. [00:04:16]-[00:06:26]
