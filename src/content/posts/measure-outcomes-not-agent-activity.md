...
Review can create a similar gap. Brian Scanlan, a senior principal engineer in Intercom's platform group, reports doubled pull-request throughput after the company standardized on Claude Code, while also identifying code review as the next bottleneck and acknowledging a concurrent increase in model capability ([00:15:18–00:16:06](https://www.youtube.com/watch?v=4_VQBbs2iQA&t=918s)). The report is useful as an internal operating observation. It does not isolate the cause of the increase or show that twice the pull-request activity produced twice the customer value.
...
- **Intercom:** Scanlan describes a real adoption program with executive expectations, dedicated enablement, organization-specific guidance, reusable skills, telemetry, and review controls ([00:05:51–00:13:28](https://www.youtube.com/watch?v=4_VQBbs2iQA&t=351s)). Its doubled pull-request throughput remains a presenter-reported activity measure, coincides with stronger models, and lacks the definitions, comparison group, and customer outcomes needed for a causal productivity claim ([00:15:18–00:18:58](https://www.youtube.com/watch?v=4_VQBbs2iQA&t=918s)).
